...
public class GuiScrollTextures extends GuiScrollOptions {
   ...
   public GuiScrollTextures(int id, int posX, int posY, int width, int height, File file, FontRenderer font) {
      this(id, posX, posY, width, height, file, font, 4);
   }

   public GuiScrollTextures(int id, int posX, int posY, int width, int height, File file, FontRenderer font, int values) {
