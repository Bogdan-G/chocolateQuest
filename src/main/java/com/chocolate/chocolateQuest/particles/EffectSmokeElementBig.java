...
public class EffectSmokeElementBig extends EffectSmoke {
   ...
   public EffectSmokeElementBig(World par1World, double posX, double posY, double posZ, double par8, double par10, double par12, Elements element) {
